...
export gVCFpath=/oasis/tscc/scratch/mioverto/data/variants/BYm_aligned/
...
java -jar $GATK CombineGVCFs  \
    -R $REFSEQ \
    --variant $gVCFlist \
    -O ${gVCFpath}/anc_BY.g.vcf.gz

java -jar $GATK GenotypeGVCFs \
   -R $REFSEQ \
   -V ${gVCFpath}/H_A00_BYm.g.vcf \
   -O ${gVCFpath}/finalVCFs/H_A00_BYm_Biallc.vcf \
...
gatk VariantFiltration \ 
 ...
 # rclone copy TSCC:/oasis/tscc/scratch/mioverto/data/variants/BYm_aligned/finalVCFs/H_A00_BYm_Biallc.vcf ./
